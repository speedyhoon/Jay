...
func TestFuzz_13(t *testing.T) {
	...
	actual = Thirteen{
		...
		Eleven:   [6]rune(rando.Int32sN(6)),
		Twelve:   [6]rune(rando.Int32sN(6)),
		Thirteen: [6]rune(rando.Int32sN(6)),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_14(t *testing.T) {
	...
	actual = Fourteen{
		...
		Twelve:   [6]rune(rando.Int32sN(6)),
		Thirteen: [6]rune(rando.Int32sN(6)),
		Fourteen: [6]rune(rando.Int32sN(6)),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_15(t *testing.T) {
	...
	actual = Fifteen{
		...
		Thirteen: [6]rune(rando.Int32sN(6)),
		Fourteen: [6]rune(rando.Int32sN(6)),
		Fifteen:  [6]rune(rando.Int32sN(6)),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_16(t *testing.T) {
	...
	actual = Sixteen{
		...
		Fourteen: [6]rune(rando.Int32sN(6)),
		Fifteen:  [6]rune(rando.Int32sN(6)),
		Sixteen:  [6]rune(rando.Int32sN(6)),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_17(t *testing.T) {
	...
	actual = Seventeen{
		...
		Fifteen:   [6]rune(rando.Int32sN(6)),
		Sixteen:   [6]rune(rando.Int32sN(6)),
		Seventeen: [6]rune(rando.Int32sN(6)),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_18(t *testing.T) {
	...
	actual = Eighteen{
		...
		Sixteen:   [6]rune(rando.Int32sN(6)),
		Seventeen: [6]rune(rando.Int32sN(6)),
		Eighteen:  [6]rune(rando.Int32sN(6)),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_19(t *testing.T) {
	...
	actual = Nineteen{
		...
		Seventeen: [6]rune(rando.Int32sN(6)),
		Eighteen:  [6]rune(rando.Int32sN(6)),
		Nineteen:  [6]rune(rando.Int32sN(6)),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_21(t *testing.T) {
	...
	actual = TwentyOne{
		...
		Nineteen:  [6]rune(rando.Int32sN(6)),
		Twenty:    [6]rune(rando.Int32sN(6)),
		TwentyOne: [6]rune(rando.Int32sN(6)),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_22(t *testing.T) {
	...
	actual = TwentyTwo{
		...
		Twenty:    [6]rune(rando.Int32sN(6)),
		TwentyOne: [6]rune(rando.Int32sN(6)),
		TwentyTwo: [6]rune(rando.Int32sN(6)),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_23(t *testing.T) {
	...
	actual = TwentyThree{
		...
		TwentyOne:   [6]rune(rando.Int32sN(6)),
		TwentyTwo:   [6]rune(rando.Int32sN(6)),
		TwentyThree: [6]rune(rando.Int32sN(6)),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
