...
func TestFuzz_1(t *testing.T) {
	...
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src), "One has %d items: %s", len(actual.One), strings.Join(actual.One, ","))
