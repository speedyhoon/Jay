...
func TestFuzz_17(t *testing.T) {
	...
	expected = Seventeen{
		...
		Fifteen:   cpx(rando.Complex128()),
		Sixteen:   cpx(rando.Complex128()),
		Seventeen: cpx(rando.Complex128()),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_21(t *testing.T) {
	...
	expected = TwentyOne{
		...
		Nineteen:  cpx(rando.Complex128()),
		Twenty:    cpx(rando.Complex128()),
		TwentyOne: cpx(rando.Complex128()),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_22(t *testing.T) {
	...
	expected = TwentyTwo{
		...
		Twenty:    cpx(rando.Complex128()),
		TwentyOne: cpx(rando.Complex128()),
		TwentyTwo: cpx(rando.Complex128()),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_23(t *testing.T) {
	...
	expected = TwentyThree{
		...
		TwentyOne:   cpx(rando.Complex128()),
		TwentyTwo:   cpx(rando.Complex128()),
		TwentyThree: cpx(rando.Complex128()),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
