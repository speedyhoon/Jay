...
func TestFuzz_1(t *testing.T) {
	...
	expected = One{
		One: [6]complex128(rando.Complex128sN(6)),
	}
...
func TestFuzz_2(t *testing.T) {
	...
	expected = Two{
		One: [6]complex128(rando.Complex128sN(6)),
		Two: [6]complex128(rando.Complex128sN(6)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_3(t *testing.T) {
	...
	expected = Three{
		One:   [6]complex128(rando.Complex128sN(6)),
		Two:   [6]complex128(rando.Complex128sN(6)),
		Three: [6]complex128(rando.Complex128sN(6)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_4(t *testing.T) {
	...
	expected = Four{
		...
		Two:   [6]complex128(rando.Complex128sN(6)),
		Three: [6]complex128(rando.Complex128sN(6)),
		Four:  [6]complex128(rando.Complex128sN(6)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_5(t *testing.T) {
	...
	expected = Five{
		...
		Three: [6]complex128(rando.Complex128sN(6)),
		Four:  [6]complex128(rando.Complex128sN(6)),
		Five:  [6]complex128(rando.Complex128sN(6)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_6(t *testing.T) {
	...
	expected = Six{
		...
		Four:  [6]complex128(rando.Complex128sN(6)),
		Five:  [6]complex128(rando.Complex128sN(6)),
		Six:   [6]complex128(rando.Complex128sN(6)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_7(t *testing.T) {
	...
	expected = Seven{
		...
		Five:  [6]complex128(rando.Complex128sN(6)),
		Six:   [6]complex128(rando.Complex128sN(6)),
		Seven: [6]complex128(rando.Complex128sN(6)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_8(t *testing.T) {
	...
	expected = Eight{
		...
		Six:   [6]complex128(rando.Complex128sN(6)),
		Seven: [6]complex128(rando.Complex128sN(6)),
		Eight: [6]complex128(rando.Complex128sN(6)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_9(t *testing.T) {
	...
	expected = Nine{
		...
		Seven: [6]complex128(rando.Complex128sN(6)),
		Eight: [6]complex128(rando.Complex128sN(6)),
		Nine:  [6]complex128(rando.Complex128sN(6)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_10(t *testing.T) {
	...
	expected = Ten{
		...
		Eight: [6]complex128(rando.Complex128sN(6)),
		Nine:  [6]complex128(rando.Complex128sN(6)),
		Ten:   [6]complex128(rando.Complex128sN(6)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_11(t *testing.T) {
	...
	expected = Eleven{
		...
		Nine:   [6]complex128(rando.Complex128sN(6)),
		Ten:    [6]complex128(rando.Complex128sN(6)),
		Eleven: [6]complex128(rando.Complex128sN(6)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_12(t *testing.T) {
	...
	expected = Twelve{
		...
		Ten:    [6]complex128(rando.Complex128sN(6)),
		Eleven: [6]complex128(rando.Complex128sN(6)),
		Twelve: [6]complex128(rando.Complex128sN(6)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_13(t *testing.T) {
	...
	expected = Thirteen{
		...
		Eleven:   [6]complex128(rando.Complex128sN(6)),
		Twelve:   [6]complex128(rando.Complex128sN(6)),
		Thirteen: [6]complex128(rando.Complex128sN(6)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_14(t *testing.T) {
	...
	expected = Fourteen{
		...
		Twelve:   [6]complex128(rando.Complex128sN(6)),
		Thirteen: [6]complex128(rando.Complex128sN(6)),
		Fourteen: [6]complex128(rando.Complex128sN(6)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_15(t *testing.T) {
	...
	expected = Fifteen{
		...
		Thirteen: [6]complex128(rando.Complex128sN(6)),
		Fourteen: [6]complex128(rando.Complex128sN(6)),
		Fifteen:  [6]complex128(rando.Complex128sN(6)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_16(t *testing.T) {
	...
	expected = Sixteen{
		...
		Fourteen: [6]complex128(rando.Complex128sN(6)),
		Fifteen:  [6]complex128(rando.Complex128sN(6)),
		Sixteen:  [6]complex128(rando.Complex128sN(6)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_17(t *testing.T) {
	...
	expected = Seventeen{
		...
		Fifteen:   [6]complex128(rando.Complex128sN(6)),
		Sixteen:   [6]complex128(rando.Complex128sN(6)),
		Seventeen: [6]complex128(rando.Complex128sN(6)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_18(t *testing.T) {
	...
	expected = Eighteen{
		...
		Sixteen:   [6]complex128(rando.Complex128sN(6)),
		Seventeen: [6]complex128(rando.Complex128sN(6)),
		Eighteen:  [6]complex128(rando.Complex128sN(6)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_19(t *testing.T) {
	...
	expected = Nineteen{
		...
		Seventeen: [6]complex128(rando.Complex128sN(6)),
		Eighteen:  [6]complex128(rando.Complex128sN(6)),
		Nineteen:  [6]complex128(rando.Complex128sN(6)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_20(t *testing.T) {
	...
	expected = Twenty{
		...
		Eighteen:  [6]complex128(rando.Complex128sN(6)),
		Nineteen:  [6]complex128(rando.Complex128sN(6)),
		Twenty:    [6]complex128(rando.Complex128sN(6)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_21(t *testing.T) {
	...
	expected = TwentyOne{
		...
		Nineteen:  [6]complex128(rando.Complex128sN(6)),
		Twenty:    [6]complex128(rando.Complex128sN(6)),
		TwentyOne: [6]complex128(rando.Complex128sN(6)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_22(t *testing.T) {
	...
	expected = TwentyTwo{
		...
		Twenty:    [6]complex128(rando.Complex128sN(6)),
		TwentyOne: [6]complex128(rando.Complex128sN(6)),
		TwentyTwo: [6]complex128(rando.Complex128sN(6)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_23(t *testing.T) {
	...
	expected = TwentyThree{
		...
		TwentyOne:   [6]complex128(rando.Complex128sN(6)),
		TwentyTwo:   [6]complex128(rando.Complex128sN(6)),
		TwentyThree: [6]complex128(rando.Complex128sN(6)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
