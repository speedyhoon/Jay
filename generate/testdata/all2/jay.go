...
func (f *Fuzz273) MarshalJ() (b []byte) {
	l0 := len(f.Two)
	b = make([]byte, 9+8*l0)
	b[0] = byte(l0)
	jay.WriteIntX64(b[1:9], f.One)
...
func (f *Fuzz274) MarshalJ() (b []byte) {
	b = make([]byte, 16)
	jay.WriteIntX64(b[:8], f.One)
	jay.WriteUintX64(b[8:], f.Two)
	return
...
func (f *Fuzz624) MarshalJ() (b []byte) {
	l0 := len(f.Two)
	b = make([]byte, 9+2*l0)
	b[0] = byte(l0)
	jay.WriteUintX64(b[1:9], f.One)
...
func (f *Fuzz625) MarshalJ() (b []byte) {
	l0 := len(f.Two)
	b = make([]byte, 9+4*l0)
	b[0] = byte(l0)
	jay.WriteUintX64(b[1:9], f.One)
...
func (f *Fuzz631) MarshalJ() (b []byte) {
	l0 := len(f.Two)
	b = make([]byte, 9+8*l0)
	b[0] = byte(l0)
	jay.WriteUintX64(b[1:9], f.One)
