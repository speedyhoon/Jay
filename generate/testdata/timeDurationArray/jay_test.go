...
func TestFuzz_1(t *testing.T) {
	...
	expected = One{
		One: [7]time.Duration(rando.DurationsN(7)),
	}
...
func TestFuzz_2(t *testing.T) {
	...
	expected = Two{
		One: [7]time.Duration(rando.DurationsN(7)),
		Two: [7]time.Duration(rando.DurationsN(7)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_3(t *testing.T) {
	...
	expected = Three{
		One:   [7]time.Duration(rando.DurationsN(7)),
		Two:   [7]time.Duration(rando.DurationsN(7)),
		Three: [7]time.Duration(rando.DurationsN(7)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_4(t *testing.T) {
	...
	expected = Four{
		...
		Two:   [7]time.Duration(rando.DurationsN(7)),
		Three: [7]time.Duration(rando.DurationsN(7)),
		Four:  [7]time.Duration(rando.DurationsN(7)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_5(t *testing.T) {
	...
	expected = Five{
		...
		Three: [7]time.Duration(rando.DurationsN(7)),
		Four:  [7]time.Duration(rando.DurationsN(7)),
		Five:  [7]time.Duration(rando.DurationsN(7)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_6(t *testing.T) {
	...
	expected = Six{
		...
		Four:  [7]time.Duration(rando.DurationsN(7)),
		Five:  [7]time.Duration(rando.DurationsN(7)),
		Six:   [7]time.Duration(rando.DurationsN(7)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_7(t *testing.T) {
	...
	expected = Seven{
		...
		Five:  [7]time.Duration(rando.DurationsN(7)),
		Six:   [7]time.Duration(rando.DurationsN(7)),
		Seven: [7]time.Duration(rando.DurationsN(7)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_8(t *testing.T) {
	...
	expected = Eight{
		...
		Six:   [7]time.Duration(rando.DurationsN(7)),
		Seven: [7]time.Duration(rando.DurationsN(7)),
		Eight: [7]time.Duration(rando.DurationsN(7)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_9(t *testing.T) {
	...
	expected = Nine{
		...
		Seven: [7]time.Duration(rando.DurationsN(7)),
		Eight: [7]time.Duration(rando.DurationsN(7)),
		Nine:  [7]time.Duration(rando.DurationsN(7)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_10(t *testing.T) {
	...
	expected = Ten{
		...
		Eight: [7]time.Duration(rando.DurationsN(7)),
		Nine:  [7]time.Duration(rando.DurationsN(7)),
		Ten:   [7]time.Duration(rando.DurationsN(7)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_11(t *testing.T) {
	...
	expected = Eleven{
		...
		Nine:   [7]time.Duration(rando.DurationsN(7)),
		Ten:    [7]time.Duration(rando.DurationsN(7)),
		Eleven: [7]time.Duration(rando.DurationsN(7)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_12(t *testing.T) {
	...
	expected = Twelve{
		...
		Ten:    [7]time.Duration(rando.DurationsN(7)),
		Eleven: [7]time.Duration(rando.DurationsN(7)),
		Twelve: [7]time.Duration(rando.DurationsN(7)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_13(t *testing.T) {
	...
	expected = Thirteen{
		...
		Eleven:   [7]time.Duration(rando.DurationsN(7)),
		Twelve:   [7]time.Duration(rando.DurationsN(7)),
		Thirteen: [7]time.Duration(rando.DurationsN(7)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_14(t *testing.T) {
	...
	expected = Fourteen{
		...
		Twelve:   [7]time.Duration(rando.DurationsN(7)),
		Thirteen: [7]time.Duration(rando.DurationsN(7)),
		Fourteen: [7]time.Duration(rando.DurationsN(7)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_15(t *testing.T) {
	...
	expected = Fifteen{
		...
		Thirteen: [7]time.Duration(rando.DurationsN(7)),
		Fourteen: [7]time.Duration(rando.DurationsN(7)),
		Fifteen:  [7]time.Duration(rando.DurationsN(7)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_16(t *testing.T) {
	...
	expected = Sixteen{
		...
		Fourteen: [7]time.Duration(rando.DurationsN(7)),
		Fifteen:  [7]time.Duration(rando.DurationsN(7)),
		Sixteen:  [7]time.Duration(rando.DurationsN(7)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_17(t *testing.T) {
	...
	expected = Seventeen{
		...
		Fifteen:   [7]time.Duration(rando.DurationsN(7)),
		Sixteen:   [7]time.Duration(rando.DurationsN(7)),
		Seventeen: [7]time.Duration(rando.DurationsN(7)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_18(t *testing.T) {
	...
	expected = Eighteen{
		...
		Sixteen:   [7]time.Duration(rando.DurationsN(7)),
		Seventeen: [7]time.Duration(rando.DurationsN(7)),
		Eighteen:  [7]time.Duration(rando.DurationsN(7)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_19(t *testing.T) {
	...
	expected = Nineteen{
		...
		Seventeen: [7]time.Duration(rando.DurationsN(7)),
		Eighteen:  [7]time.Duration(rando.DurationsN(7)),
		Nineteen:  [7]time.Duration(rando.DurationsN(7)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_20(t *testing.T) {
	...
	expected = Twenty{
		...
		Eighteen:  [7]time.Duration(rando.DurationsN(7)),
		Nineteen:  [7]time.Duration(rando.DurationsN(7)),
		Twenty:    [7]time.Duration(rando.DurationsN(7)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_21(t *testing.T) {
	...
	expected = TwentyOne{
		...
		Nineteen:  [7]time.Duration(rando.DurationsN(7)),
		Twenty:    [7]time.Duration(rando.DurationsN(7)),
		TwentyOne: [7]time.Duration(rando.DurationsN(7)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_22(t *testing.T) {
	...
	expected = TwentyTwo{
		...
		Twenty:    [7]time.Duration(rando.DurationsN(7)),
		TwentyOne: [7]time.Duration(rando.DurationsN(7)),
		TwentyTwo: [7]time.Duration(rando.DurationsN(7)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
...
func TestFuzz_23(t *testing.T) {
	...
	expected = TwentyThree{
		...
		TwentyOne:   [7]time.Duration(rando.DurationsN(7)),
		TwentyTwo:   [7]time.Duration(rando.DurationsN(7)),
		TwentyThree: [7]time.Duration(rando.DurationsN(7)),
	}
	src := expected.MarshalJ()
	require.NoError(t, actual.UnmarshalJ(src))
