...
func TestFuzz_23(t *testing.T) {
	...
	actual = TwentyThree{
		...
		TwentyOne:   [6]int(rando.IntsN(6)),
		TwentyTwo:   [6]int(rando.IntsN(6)),
		TwentyThree: [6]int(rando.IntsN(6)),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
