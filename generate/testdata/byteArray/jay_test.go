...
func TestFuzz_13(t *testing.T) {
	...
	actual = Thirteen{
		...
		Eleven:   [15]byte(rando.BytesNil()),
		Twelve:   [15]byte(rando.BytesNil()),
		Thirteen: [15]byte(rando.BytesNil()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_14(t *testing.T) {
	...
	actual = Fourteen{
		...
		Twelve:   [15]byte(rando.BytesNil()),
		Thirteen: [15]byte(rando.BytesNil()),
		Fourteen: [15]byte(rando.BytesNil()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_15(t *testing.T) {
	...
	actual = Fifteen{
		...
		Thirteen: [15]byte(rando.BytesNil()),
		Fourteen: [15]byte(rando.BytesNil()),
		Fifteen:  [15]byte(rando.BytesNil()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_16(t *testing.T) {
	...
	actual = Sixteen{
		...
		Fourteen: [15]byte(rando.BytesNil()),
		Fifteen:  [15]byte(rando.BytesNil()),
		Sixteen:  [15]byte(rando.BytesNil()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_17(t *testing.T) {
	...
	actual = Seventeen{
		...
		Fifteen:   [15]byte(rando.BytesNil()),
		Sixteen:   [15]byte(rando.BytesNil()),
		Seventeen: [15]byte(rando.BytesNil()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_18(t *testing.T) {
	...
	actual = Eighteen{
		...
		Sixteen:   [15]byte(rando.BytesNil()),
		Seventeen: [15]byte(rando.BytesNil()),
		Eighteen:  [15]byte(rando.BytesNil()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_19(t *testing.T) {
	...
	actual = Nineteen{
		...
		Seventeen: [15]byte(rando.BytesNil()),
		Eighteen:  [15]byte(rando.BytesNil()),
		Nineteen:  [15]byte(rando.BytesNil()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_21(t *testing.T) {
	...
	actual = TwentyOne{
		...
		Nineteen:  [15]byte(rando.BytesNil()),
		Twenty:    [15]byte(rando.BytesNil()),
		TwentyOne: [15]byte(rando.BytesNil()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_22(t *testing.T) {
	...
	actual = TwentyTwo{
		...
		Twenty:    [15]byte(rando.BytesNil()),
		TwentyOne: [15]byte(rando.BytesNil()),
		TwentyTwo: [15]byte(rando.BytesNil()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_23(t *testing.T) {
	...
	actual = TwentyThree{
		...
		TwentyOne:   [15]byte(rando.BytesNil()),
		TwentyTwo:   [15]byte(rando.BytesNil()),
		TwentyThree: [15]byte(rando.BytesNil()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
