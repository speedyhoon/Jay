...
// See jay/genjay for the internals.
//
// Options:
//
...
func main() {
	...
	flag.BoolVar(&opt.Is32bit, "32", genjay.IntSize == 32, "Force 32-bit output for 'int' and 'uint' types. Defaults to this system's architecture.")
...
func walkDir(path string, opt genjay.Option) (filenames []string) {
