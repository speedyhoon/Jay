...
func BenchmarkReadBool3(b *testing.B) {
	var i byte
	for b.Loop() {
		bool1, bool2, bool3 = jay.ReadBool3(i)
		i++
	}
}
func BenchmarkReadBool4(b *testing.B) {
	var i byte
	for b.Loop() {
		bool1, bool2, bool3, bool4 = jay.ReadBool4(i)
		i++
	}
}
func BenchmarkReadBool5(b *testing.B) {
	var i byte
	for b.Loop() {
		bool1, bool2, bool3, bool4, bool5 = jay.ReadBool5(i)
		i++
	}
}
func BenchmarkReadBool6(b *testing.B) {
	var i byte
	for b.Loop() {
		bool1, bool2, bool3, bool4, bool5, bool6 = jay.ReadBool6(i)
		i++
	}
}
func BenchmarkReadBool7(b *testing.B) {
	var i byte
	for b.Loop() {
		bool1, bool2, bool3, bool4, bool5, bool6, bool7 = jay.ReadBool7(i)
		i++
	}
}
func BenchmarkReadBool8(b *testing.B) {
	var i byte
	for b.Loop() {
		bool1, bool2, bool3, bool4, bool5, bool6, bool7, bool8 = jay.ReadBool8(i)
		i++
	}
}
